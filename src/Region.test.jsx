...
describe('Region', () => {
  ...
  const renderCategory = ({ region, isSelected = false }) => render((
    <Region
      region={region}
  ...
  it('카테고리 목록이 랜더링된다', () => {
    ...
    const { container } = renderCategory({ region });
  ...
  context('카테고리를 선택하면', () => {
    it('선택한 카테고리에 "V"가 랜더링된다', () => {
      ...
      const { container } = renderCategory({ region, isSelected: true });
  ...
  context('카테고리를 선택하지 않은 목록에는', () => {
    it('"V"가 랜더링되지 않는다', () => {
      ...
      const { container } = renderCategory({ region, isSelected: false });
